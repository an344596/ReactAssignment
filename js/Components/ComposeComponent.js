...
var ComposeModal = React.createClass({
  ...
  sendMessage: function()
  {
    ...
    $.ajax({
      url: ' https://www.googleapis.com/gmail/v1/users/anumolredrose%40gmail.com/messages/send?key={AIzaSyApZnixq68ru01UHi_tQKUjIUo9-edS8LU}',
      dataType: 'json',
  ...
  render: function()
  {
    return(
      ...
      <div className="col-lg-10">
      <textarea rows="20" cols="40" onChange={this.handleMessageState} className="form-control" id="msg" name="" required></textarea>
      </div>
      </div>
      </form>
      </div>
